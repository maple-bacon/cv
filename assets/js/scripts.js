...
// Hover box  ----------------------------------------
	...
	$('.fullscene-video').click(function(){
		$('#header , #wrapper , .overlay').fadeOut(10);
		$('.fullscene-close').fadeIn(10);
		$('.mb_YTVPBar .buttonBar').animate({opacity:1},{queue:true,duration:200,easing:"swing"});
	});
}
...
// Mobile nav button ----------------------------------------
	...
	function hidefuulscene(){
		$('#header , #wrapper , .overlay').fadeIn(10);
		$('.fullscene-close').fadeOut(10);
		$('.mb_YTVPBar .buttonBar').animate({opacity:0},{queue:true,duration:200,easing:"swing"});
	}
	$('.fullscene-close').click(function(){
		hidefuulscene();
	});
